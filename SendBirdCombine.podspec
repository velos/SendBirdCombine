...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/zac/SendBirdCombine'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'zac' => 'zac@velosmobile.com' }
  s.source           = { :git => 'https://github.com/zac/SendBirdCombine.git', :tag => s.version.to_s }
  ...
  # s.resource_bundles = {
  #   'SendBirdCombine' => ['SendBirdCombine/Assets/*.png']
  # }
